...
class UserLoginModel {
  ...
  @override
  String toString() {
    return 'UserLoginModel(firstName: $firstName, lastName: $lastName, username: $username, password: $password, email: $email, address: $address, role: $role, phoneNumber: $phoneNumber, dateOfBirth: $dateOfBirth, accessToken: $accessToken)';
  }
